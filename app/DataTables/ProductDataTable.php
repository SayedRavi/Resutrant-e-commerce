    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query){
                $edit = "<a href='".route('admin.product.edit',$query->id)."' class='btn btn-sm btn-primary'><i class='fas fa-edit'></i></a>";
                $delete = "<a href='".route('admin.product.destroy',$query->id)."' class='btn btn-sm btn-danger delete-item mx-1'><i class='fas fa-trash'></i></a>";
                ...
                $more = '<div class="btn-group dropleft">
                      ...
                      <div class="dropdown-menu dropleft" x-placement="left-start" style="position: absolute; transform: translate3d(-202px, 0px, 0px); top: 0px; left: 0px; will-change: transform;">
                        ...
                        <a class="dropdown-item" href="'.route('admin.product-size-show.index', $query->id).'">Product Variant</a>
                      </div>
                    </div>';
            ...
            ->rawColumns(['price', 'offer_price', 'show_at_home', 'status', 'image', 'action'])
            ->setRowId('id');
    }
