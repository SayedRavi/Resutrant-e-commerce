    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query){
                $edit = "<a href='".route('admin.daily-offer.edit',$query->id)."' class='btn btn-sm btn-primary'><i class='fas fa-edit'></i></a>";
                $delete = "<a href='".route('admin.daily-offer.destroy',$query->id)."' class='btn btn-sm btn-danger delete-item ml-2'><i class='fas fa-trash'></i></a>";
                return $edit.$delete;
            })
