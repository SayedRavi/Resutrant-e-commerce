    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query){
                $edit = "<a class='btn btn-sm btn-primary' href='".route('admin.why-choose-us.edit',$query->id)."'><i class='fas fa-edit'></i></a>";
                $delete = "<a class='btn btn-sm btn-danger ml-1 delete-item' href='".route('admin.why-choose-us.destroy',$query->id)."'><i class='fas fa-trash'></i></a>";
