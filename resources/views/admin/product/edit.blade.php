            ...
            <div class="card-body">
                <form action="{{route('admin.product.update', $product->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="short_description" id="" cols="30" rows="10" class="form-control">{!! $product->short_description !!}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="seo_description" id="" cols="30" rows="10" class="form-control">{!! $product->seo_description !!}</textarea>
                    </div>
