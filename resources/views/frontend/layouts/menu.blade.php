    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item">
                    ...
                    <ul class="droap_menu">
                        ...
                        <li><a href="{{route('testimonial.testimonials')}}">testimonial</a></li>
            ...
            <ul class="menu_icon d-flex flex-wrap">
                ...
                <li>
                    <a class="cart_icon"><i class="fas fa-shopping-basket"></i> <span class="cart-count">{{count(\Gloudemans\Shoppingcart\Facades\Cart::content())}}</span></a>
                </li>
                @php
...
<div class="fp__menu_cart_area">
    <div class="fp__menu_cart_boody">
        <div class="fp__menu_cart_header">
            <h5>total item (<span class="cart-count">{{count(\Gloudemans\Shoppingcart\Facades\Cart::content())}}</span>)</h5>
        ...
        <ul class="cart-content">
            ...
            <li>
                ...
                <div class="menu_cart_text">
                    ...
                    <p class="size">{{@$cartContent->options->product_size['name']}} {{@$cartContent->options->product_size['price'] ? '('.currencyPosition(@$cartContent->options->product_size['price']).')' : ''}}</p>
        ...
        <p class="subtotal">sub total <span class="cart-subtotal">{{currencyPosition(cartTotal())}}</span></p>
