...
<meta property="og:title" content="{{!empty($blog->seo_title)? $blog->seo_title : $blog->title}}">
<meta property="og:description" content="{{!empty($blog->seo_description) ? $blog->seo_description : $blog->description}}">
                        ...
                        @if($previousBlog)
                            <li>
                                <a href="{{route('blog.details', $previousBlog->slug)}}">
                                    <img src="{{asset($previousBlog->image)}}" alt="{{$previousBlog->title}}" class="img-fluid w-100">
                                    <p>{{truncate($previousBlog->title, 50)}}
                        ...
                        @if($nextBlog)
                            <li>
                                <a href="{{route('blog.details', $nextBlog->slug)}}">
                                    ...
                                    <img src="{{asset($nextBlog->image)}}" alt="{{$nextBlog->title}}" class="img-fluid w-100">
                                </a>
                            </li>
                        @endif
                            ...
                            <ul>
                                @foreach($latestBlogs as $latestBlog)
                                    <li>
                                        ...
                                        <div class="text">
                                            <a href="#">{{truncate($latestBlog->title, 50)}}</a>
