...
@section('content')
    ...
    <!--=============================
        BLOG PAGE START
    ==============================-->
    <section class="fp__blog_page fp__blog2 mt_120 xs_mt_65 mb_100 xs_mb_70 mb-4">
        <div class="container">
            ...
            <div class="row">
                @foreach($blogs as $blog)
                    <div class="col-xl-4 col-sm-6 col-lg-4 wow fadeInUp mt-4" data-wow-duration="1s">
                        <div class="fp__single_blog">
                            ...
                            <div class="fp__single_blog_text">
                                ...
                                <a class="title" href="{{route('blog.details', $blog->slug)}}">{{truncate($blog->title, 30)}}</a>
                            </div>
                        </div>
                    </div>
